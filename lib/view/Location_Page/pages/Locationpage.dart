...
import '../../Location_View/Pages/Location_Page.dart';

//typedef TaskExecutor = void Function();
class LocationPage extends StatefulWidget {const LocationPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: ListView(
          children: [
            Padding(
              ...
              child: Text("Delivery Locations",style:GoogleFonts.poppins(
      ...
      floatingActionButton:  FloatingActionButton(onPressed: () async {
        ...
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const LocationView(),));
        }
        else
          {
