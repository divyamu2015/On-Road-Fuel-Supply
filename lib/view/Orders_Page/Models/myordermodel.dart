...
class GetUserOrderModel {
    ...
    factory GetUserOrderModel.fromRawJson(String str) => GetUserOrderModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory GetUserOrderModel.fromJson(Map<String, dynamic> json) => GetUserOrderModel(
